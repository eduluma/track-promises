...
| Mobile phone (OTP) | OTP-based login — India-friendly, no password required |
...
3. OTP or email link sent; on verification, `state` transitions to `verified`.
...
- Support OTP via SMS and email for India-context tenants.
