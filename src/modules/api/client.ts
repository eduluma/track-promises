...
import {
    ...
    type UpdateTenantLocalizationPayload,
    type VotePayload
...
type WebApiClient = {
    ...
    updateTenantLocalization(body: unknown, user: ApiUserContext): Promise<ApiHandlerResult<UpdateTenantLocalizationPayload>>;
};
...
function createLocalWebApiClient(): WebApiClient {
    return {
        ...
        async updateTenantLocalization(body: unknown, user: ApiUserContext) {
            return handleUpdateTenantLocalization(body, user);
        }
    };
}
...
function createRemoteWebApiClient(): WebApiClient {
    return {
        ...
        async updateTenantLocalization(body: unknown, user: ApiUserContext) {
            return postJson<UpdateTenantLocalizationPayload>("/admin/tenants/localization", body, user);
        }
    };
}
...
export type { WebApiClient, VoteRequest, CreatePromiseRequest, ResolveModerationReviewRequest, UpdateTenantLocalizationRequest };