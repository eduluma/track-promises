...
function includeSampleSeedData() {
    const configured = process.env.TRACK_PROMISES_INCLUDE_SAMPLE_SEED_DATA;
...
export function getFoundationSeedData() {
    const includeSampleData = includeSampleSeedData();
    ...
    return {
        tenants,
        users: includeSampleData ? demoUsers : [],
        timelines,
        alliances,
        timelineAlliances,
        tenantConfigs,
        ...
        sources,
        votingWindows,
        votes: includeSampleData ? seedVoteRecords : [],
        voteEvents: includeSampleData ? [...seedVoteEventRecords, ...voteEvents] : [],
        voteSnapshots: includeSampleData ? seedVoteSnapshotRecords : [],
        statusHistory,
        moderationReviews: includeSampleData ? seedModerationReviews : [],
